  ...
  return (
    <div className="home">
      <div className="home-header">
        ...
        <p className="home-subtitle">Learn Polish with spaced repetition</p>
      </div>
      ...
      {totalCount > 0 && (
        <div className="direction-selector">
          <label className="direction-label">Learning Direction:</label>
          <div className="direction-options">
            <button
              className={`direction-btn ${selectedDirection === "polish-to-russian" ? "active" : ""}`}
              onClick={() => setSelectedDirection("polish-to-russian")}
            >
              🇵🇱 → 🇷🇺
              <span>Polish to Russian</span>
            </button>
            <button
              className={`direction-btn ${selectedDirection === "russian-to-polish" ? "active" : ""}`}
              onClick={() => setSelectedDirection("russian-to-polish")}
            >
              🇷🇺 → 🇵🇱
